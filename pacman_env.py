...
class PacmanEnv(Env):
    ...
    def _step(self, action):
        ...
        return [self.barrier_mask, self.prey_channel,
                self.predator_channel], reward, is_terminal, 'no debug information provided'
...
register(
    ...
    kwargs={'barriers': advanced_barrier, 'grid_size': 10, 'num_agents': 4, 'prey_style': 'random',
            'smart_predator': False})
