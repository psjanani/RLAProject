...
def main():
    ...
    parser.add_argument('--max_episode_length', default=25, type=int, help='Max episode length (for training, not eval).')
    ...
    parser.add_argument('--num_burn_in', default=50, type=int, help='Buffer size pre-training.')
    ...
    if args.save_weights:
        num_agent = multiagent.number_pred
