...
def main():
    ...
    parser.add_argument('--max_test_episode_length', default=100, type=int, help='Max episode length for testing.')
    parser.add_argument('--max_episode_length', default=100, type=int, help='Max episode length (for training, not eval).')
